...
class AdminModel extends CI_Model {
	...
	{
		$data = $this->db->query("SELECT dt.id_buku, bk.nama_buku, SUM(dt.quantity) AS total, t.id_toko, tk.nama_toko FROM detail_transaksi dt, transaksi t, toko tk, buku bk WHERE dt.id_transaksi = t.id_transaksi AND tk.id_toko = t.id_toko AND dt.id_buku = bk.id_buku AND dt.id_buku = '$id_buku' GROUP BY t.id_toko");
	...
	public function getBooks(){
		return $this->db->query("SELECT id_buku, nama_buku FROM buku")->result_array();
	}
	...
	public function getBookName($id){
		return $this->db->query("SELECT nama_buku FROM buku WHERE id_buku = '$id'")->result_array();
	}
	...
	public function getStoreName($id){
		return $this->db->query("SELECT nama_toko FROM toko WHERE id_toko = '$id'")->result_array();
	}
